                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-2 mb-lg-0">
                                        <h3 class="mb-0  text-white">Active task</h3>
                                    </div>
                                    <div>
                                        <a href="{{route('route.create.task')}}" class="btn btn-white">Add new task</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                {{-- {{$t->status}}  --}}
                                            <td>{{$t->name}}</td>
                                            <td class="text-success">{{$t->status}} <i style="font-size:12px;" class="fa-solid fa-circle"></i></td>
                                            <td>{{$t->startDate}}</td>
                                            <td>{{$t->endDate}}</td>
                                            <td>{{$t->user['name']}}</td>
