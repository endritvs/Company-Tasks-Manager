    ...
    <div id="db-wrapper">
      ...
      <div id="page-content">
        ...
        <div class="container-fluid mt-n22 px-6">
              ...
              <div>
                <div class="d-flex justify-content-between align-items-center">
                  <div class="mb-2 mb-lg-0">
                    <h3 class="mb-0 text-white">Add Project</h3>
                  </div>
          ...
          <br>
          <br>
          <form class="row g-3 mt-5 p-5" method="POST" action="{{ route('adm.project.create') }}">
            @csrf
           <div class="col-md-6">
          ...
          @enderror
            ...
            <div class="input-group mb-3">
              ...
              <select name="user_id" class="form-select" id="inputGroupSelect01"> 
                ...
                <option selected>Choose project manager</option>
